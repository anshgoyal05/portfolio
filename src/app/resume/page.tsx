          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between items-baseline font-sans text-xs">
                ...
                <a href="https://github.com/anshgoyal05/CivicSync" target="_blank" rel="noopener noreferrer" className="text-neutral-600 underline font-mono text-[10px]">github.com/anshgoyal05/CivicSync</a>
              </div>
